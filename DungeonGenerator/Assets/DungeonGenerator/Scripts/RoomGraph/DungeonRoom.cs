...
//public class GameplayInRoom : ScriptableObject
//{
//    private GameplayRepresentation _gameplay;
//    private DungeonRoom _roomOfNextGameplay;

//    public static GameplayInRoom Create(GameplayRepresentation gameplay)
//    {
//        GameplayInRoom gameplayInRoom = CreateInstance<GameplayInRoom>();

//        gameplayInRoom._gameplay = gameplay;

//        return gameplayInRoom;
//    }

//    // TODO add possibility to add next room to room
//}
...
public class DungeonRoom : ScriptableObject
{
    ...
    public List<GameplayRepresentation> GameplayInRoom { get{ return _gameplayInRoom; } }
